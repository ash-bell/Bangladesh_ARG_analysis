...
--only-assembler \
--phred-offset 33 \
-s $PATH/ashley/10218_SAMPLE/merged.fq.gz \
--12 $PATH/ashley/10218_SAMPLE/qtrimmed.fq.gz 
-o $PATH/ashley/10218_SAMPLE/metaPlasmidSPAdes_output \
-m 1000 \
-t 8

#metaplasmidspades.py --continue -o $PATH/ashley/10218_SAMPLE/metaPlasmidSPAdes_output

### detect plasmids from assembly using PlasClass ###
python classify_fasta.py \
-f $PATH/ashley/plasmids/SAMPLE_plasmids_scaffolds.fasta \
...
SAMPLE_VS2/checkv \
-t 16 \
-d $PATH/ashley/tools/checkv-db-v1.0
...
--db $PATH/dbs/nr/nr.2021-07-09.diamond.2.0.11.dmnd \
--out dmd_plasmid.out \
--outfmt 6 \
--threads 16
