...
kaiju -z 16 \
 ...
 -i $PATH/agb214/ARG_bangladesh_ponds/read_mapping/assemblies/REPLACE_ME_scaffolds.fasta \
...
--threads 16 \
--gzip-compressed \
$PATH/agb214/ARG_bangladesh_ponds/read_mapping/assemblies/REPLACE_ME_scaffolds.fasta > REPLACE_ME_scaffolds_kraken.out
